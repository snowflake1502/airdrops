...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'My Plans', href: '/dashboard/plans', icon: '📋' },
    { name: 'Protocols', href: '/dashboard/protocols', icon: '🔗' },
    { name: 'Activities', href: '/dashboard/activities', icon: '✅' },
    { name: 'Positions', href: '/dashboard/positions', icon: '💰' },
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="relative flex w-full max-w-xs flex-col bg-white pt-5 pb-4 shadow-xl">
            ...
            <div className="flex flex-shrink-0 items-center px-4">
              <h2 className="text-lg font-semibold text-gray-900">Airdrop Dashboard</h2>
            </div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 shadow-sm border-r border-gray-200">
          <div className="flex h-16 shrink-0 items-center">
            <h1 className="text-xl font-bold text-gray-900">Airdrop Farming</h1>
          </div>
